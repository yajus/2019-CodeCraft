    ...
    for(int i=1; i<=n; ++i)
    {
        ...
        if(int((cardata[outline][5]+3)/4)>2)
        {
            ...
            if(road1!=1)
            {
                ...
                one1=(one1/bandwidth)*c3+one1/(bandwidth2*speedlimit)*c2;//weight公式
                if(truejudge==1)
                ...
                if(point!=0)
                {
                    ...
                    if(crossdata[j][5]!=1&&crossdata[j][5]!=y)
                    {
                        ...
                        one=(one/bandwidth)*c3+one/(bandwidth2*speedlimit)*c2;//weight公式
                    }
                    if(crossdata[j][2]!=1&&crossdata[j][2]!=y)
                    {
                        ...
                        two=(two/bandwidth)*c3+two/(bandwidth2*speedlimit)*c2;//weight公式
                    }
                    if(crossdata[j][3]!=1&&crossdata[j][3]!=y)
                    {
                        ...
                        //cout<<three/(bandwidth2*speedlimit)<<endl;
                        three=(three/bandwidth)*c3+three/(bandwidth2*speedlimit)*c2;//weight公式
                    ...
                    if(crossdata[j][4]!=1&&crossdata[j][4]!=y)
                    {
                        ...
                        four=(four/bandwidth)*c3+four/(bandwidth2*speedlimit)*c2;//weight公式
                    }
                    //                    four/=deliver;
                    int average=0;
            ...
            if(road2!=1)
            {
                ...
                two1=(two1/bandwidth)*c3+two1/(bandwidth2*speedlimit)*c2;//weight公式
                if( truejudge==1)
            ...
            if(road3!=1)
            {
                ...
                three1=(three1/bandwidth)*c3+three1/(bandwidth2*speedlimit)*c2;//weight公式
                if( truejudge==1)
            ...
            if(road4!=1)
            {
                ...
                four1=(four1/bandwidth)*c3+four1/(bandwidth2*speedlimit)*c2;//weight公式
                if( truejudge==1)
